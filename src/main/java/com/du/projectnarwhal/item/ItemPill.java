...
public class ItemPill extends BaseItem {



    public ItemPill(Settings settings) {
        super(settings);
    }
            ...
            livingEntity_1.clearPotionEffects();
                 if (livingEntity_1 instanceof PlayerEntity) {
                  ...
                  ((ThingForLater)livingEntity_1).setInfectedLevel(((ThingForLater)livingEntity_1).getInfectedLevel()-(((ThingForLater)livingEntity_1).getInfectedLevel()));
                     ...
                     ((ThingForLater)livingEntity_1).setDruggedLevel(((ThingForLater)livingEntity_1).getDruggedLevel()+15.0f);
