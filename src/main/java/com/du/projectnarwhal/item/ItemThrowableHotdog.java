...
public class ItemThrowableHotdog extends BaseItem {

    public final boolean creative;

    public ItemThrowableHotdog(Settings item$Settings_1, boolean creative) {
        ...
        public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
            ...
            if (!world.isClient) {
                ...
                entity.setItem(new ItemStack(PNarwhalItems.THOTDOG));
                ...
                entity.setItem(new ItemStack(PNarwhalItems.THOTDOG));//itemStack);
