package com.du.projectnarwhal.world.gen.feature;
...
public class GalaxyTreeFeature extends AbstractTreeFeature<DefaultFeatureConfig> {
    private static final BlockState LOG;
    private static final BlockState LEAVES;

    public GalaxyTreeFeature(Function<Dynamic<?>, ? extends DefaultFeatureConfig> function_1, boolean boolean_1) {
    ...
    private void makeLeaves(ModifiableTestableWorld modifiableTestableWorld_1, int int_1, BlockPos blockPos_1, List<GalaxyTreeFeature.BranchPosition> list_1, MutableIntBoundingBox mutableIntBoundingBox_1, Set<BlockPos> set_1) {
    ...
    private void makeBranches(Set<BlockPos> set_1, ModifiableTestableWorld modifiableTestableWorld_1, int int_1, BlockPos blockPos_1, List<GalaxyTreeFeature.BranchPosition> list_1, MutableIntBoundingBox mutableIntBoundingBox_1) {
    ...
    public boolean generate(Set<BlockPos> set_1, ModifiableTestableWorld modifiableTestableWorld_1, Random random_1, BlockPos blockPos_1, MutableIntBoundingBox mutableIntBoundingBox_1) {
        ...
        if (int_1 == -1) {
            ...
            int int_5 = int_1 - 5;
            List<GalaxyTreeFeature.BranchPosition> list_1 = Lists.newArrayList();
            list_1.add(new GalaxyTreeFeature.BranchPosition(blockPos_1.up(int_5), int_4));
                    ...
                    for(int int_6 = 0; int_6 < int_3; ++int_6) {
                        ...
                        if (this.makeOrCheckBranch(set_1, modifiableTestableWorld_1, blockPos_2, blockPos_3, false, mutableIntBoundingBox_1) == -1) {
                            ...
                            if (this.makeOrCheckBranch(set_1, modifiableTestableWorld_1, blockPos_4, blockPos_2, false, mutableIntBoundingBox_1) == -1) {
                                list_1.add(new GalaxyTreeFeature.BranchPosition(blockPos_2, blockPos_4.getY()));
                            }
                        }
                    }
                }
    ...
    protected static boolean isDirtOrGrass(TestableWorld testableWorld_1, BlockPos blockPos_1) {
        return testableWorld_1.testBlockState(blockPos_1, (blockState_1) -> {
            ...
            return block_1 == Blocks.AIR || block_1 == PNarwhalBlocks.GALAXY_DIRT;
        });
    }
    ...
    protected void setToDirt(ModifiableTestableWorld modifiableTestableWorld_1, BlockPos blockPos_1) {
        if (!isNaturalDirt(modifiableTestableWorld_1, blockPos_1)) {
            this.setBlockState(modifiableTestableWorld_1, blockPos_1, PNarwhalBlocks.GALAXY_DIRT.getDefaultState());
        }
    ...
    static {
        LOG = PNarwhalBlocks.GALAXY_DIRT.getDefaultState();
        LEAVES = PNarwhalBlocks.GALAXY_DIRT.getDefaultState();
    }
