...
import com.du.projectnarwhal.world.utils.NoiseChunkPrimer;
...
public class GalaxyChunkGenerator extends SurfaceChunkGenerator<ChunkGeneratorConfig> {
    ...
    public GalaxyChunkGenerator(IWorld iWorld_1, BiomeSource biomeSource_1, ChunkGeneratorConfig config) {
