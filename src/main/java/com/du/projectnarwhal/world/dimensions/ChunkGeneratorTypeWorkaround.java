...
public class ChunkGeneratorTypeWorkaround implements InvocationHandler {
    ...
    public GalaxyChunkGenerator createProxy(World w, BiomeSource biomesource, ChunkGeneratorConfig gensettings) {
        return new GalaxyChunkGenerator(w, biomesource, gensettings);
    }
