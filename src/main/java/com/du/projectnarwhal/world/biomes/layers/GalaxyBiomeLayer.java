package com.du.projectnarwhal.world.biomes.layers;


import com.du.projectnarwhal.init.PNarwhalBiomes;
...
public enum GalaxyBiomeLayer implements InitLayer {
    INSTANCE;

    GalaxyBiomeLayer() {
        // Add vanilla nether
        this.addBiome(PNarwhalBiomes.GALAXY_PLAINS, 10);
    }
