...
public class PNarwhalGalaxyBiomeSource extends BiomeSource {
    private final BiomeLayerSampler noiseLayer;
    private final BiomeLayerSampler biomeLayer;
    private final Biome[] biomes;

    public PNarwhalGalaxyBiomeSource(long seed) {

        BiomeLayerSampler[] layerSamplers = PNarwhalGalaxyBiomeLayers.createLayers(seed);

        this.biomes = PNarwhalGalaxyBiomeLayers.getBiomes();
