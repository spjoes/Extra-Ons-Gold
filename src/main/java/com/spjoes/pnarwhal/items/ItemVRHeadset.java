...
public class ItemVRHeadset extends Item {

	public ItemVRHeadset() {
		super();
		this.setRegistryName(new ResourceLocation(Constants.MODID, "vr_headset"));
		this.setUnlocalizedName("vr_headset");
